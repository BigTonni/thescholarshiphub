...
class NHP_Options{
	...
	*/
	function _enqueue(){
		...
		wp_register_style(
				'nhp-opts-css', 
				get_template_directory_uri().'/inc/options/options/css/options.css',
				array('farbtastic'),
				time(),
				'all'
			);
		wp_register_style(
			...
			apply_filters('nhp-opts-ui-theme', get_template_directory_uri().'/inc/options/options/css/jquery-ui-aristo/aristo.css'),
			'',
			time(),
			'all'
		);
		...
		wp_enqueue_script(
			'nhp-opts-js', 
			get_template_directory_uri().'/inc/options/options/js/options.js', 
			array('jquery'),
			time(),
			true
		);
