                                ...
                                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                                        <div class="entry-content">
                                                <div class="col-md-12 tabs_container">
                                                        ...
                                                        $is_member_benefits_tab = false;
                                                        
                                                        if ($user != false && defined( 'RCP_PLUGIN_DIR' ) && (rcp_get_subscription_id() >= 2 || current_user_can('administrator'))) {
                                                            ...
                                                            $is_email_premium_tab = (rcp_get_subscription_id() == 3 || current_user_can('administrator')) ? true : false;
                                                            
                                                            $is_member_benefits_tab = true;
                                                        }
                                                        ?>
                                                        <ul class="nav nav-tabs">
                                                                ...
                                                                if (!empty($arr_scholarship_ids)) { ?>
                                                                    <li role="presentation" class="tab4" ><a data-tab="4" href="#">Favorited scholarships</a></li>
                                                                <?php }
