		...
		<tr>
			...
			<td data-th="<?php esc_attr_e( 'Actions', 'rcp' ); ?>">
				...
				if ( rcp_can_member_renew() ) {
					$links[] = apply_filters( 'rcp_subscription_details_action_renew', '<a href="' . esc_url( get_permalink( $rcp_options['registration_page'] ) ) . '?level='. rcp_get_subscription_id() .'" title="' . __( 'Renew your subscription', 'rcp' ) . '" class="rcp_sub_details_renew">' . __( 'Renew your subscription', 'rcp' ) . '</a>', $user_ID );
				}

				if ( rcp_subscription_upgrade_possible( $user_ID ) ) {
					$links[] = apply_filters( 'rcp_subscription_details_action_upgrade', '<a href="' . esc_url( get_permalink( $rcp_options['registration_page'] ) ) . '?level='. rcp_get_subscription_id() .'" title="' . __( 'Upgrade or change your subscription', 'rcp' ) . '" class="rcp_sub_details_renew">' . __( 'Upgrade or change your subscription', 'rcp' ) . '</a>', $user_ID );
				}
